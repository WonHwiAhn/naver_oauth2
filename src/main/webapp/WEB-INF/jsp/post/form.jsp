...
<body>
	...
	<form:form action="${actionUrl}" commandName="post" onsubmit="if($('#pen').html()!='<p><br></p>')$('#content').val($('#pen').html()); pen.destroy();" method="post">
	    ...
	    <%-- <form:input type="text" path="userName" id="userName" value="${user.userName}"/>
	    <form:input type="text" path="auth" id="auth" value="${user.auth}"/> --%>
	...
	<p class="text-muted">Powered By <a href="http://jsoone.com">jsoone</a> | WYSIWYG Editor by <a href="https://github.com/sofish/pen">Pen Editor</a></p>
